                     ...
                     <div className="invalid-status">
                        <div className="card-inner card-star-5 main-card-inner">
                           <div className="card-content">
                              <div className="card-content-inner py-4 relative z-[1]">
                                 <div className="card-main-image">
                                    <img src="/supply-5.png" alt="supply" className='bg-[center] bg-[length:100%_100%] bg-no-repeat absolute bottom-0 left-0 z-[1]' />
                                 ...
                                 <div className="card-right">
                                    ...
                                    <div className="card-images *:relative *:*:object-cover">
                                       ...
                                       <div>
                                          <img src={testAware.portrait[1].image} alt="portrait-img" />
                                       </div>
                                       <div>
                                          <img src={testAware.portrait[2].image} alt="portrait-img" />
                                       </div>
                                    </div>
                                 </div>
                              </div>
